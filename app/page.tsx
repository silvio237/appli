          ...
          <div className="max-w-lg">
            ...
            <ul className="steps steps-vertical lg:steps-horizontal">
              <li className="step step-secondary text-sm">
                <div className="badge">Créer un compte</div>
              </li>
              <li className="step step-secondary text-sm">
                <div className="badge">Réservez votre salle</div>
              </li>
              <li className="step step-secondary text-sm">
                <div className="badge">Gérez vos réservations</div>
              </li>
            </ul>
        ...
        <div className="p-5 md:p-0">
          <div className="relative rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-900/10 lg:rounded-2xl lg:p-4 w-full md:w-[1200px] md:h-[990px]">
            <Image
              ...
              height={500}
              quality={100}
              className="rounded-md shadow-2xl ring-1 ring-gray-900/10 object-cover filter saturate-100 w-full h-full"
            />
          </div>
        </div>
      </div>
